...
//	
//	static List<Map<String, Object>> SimpleAdapterEventdata = new ArrayList<Map<String, Object>>();
//	
//	// all type channel
...
//		RelativeLayout.LayoutParams FocusChanItemLayout = new RelativeLayout.LayoutParams(
//				10, 10);
...
//		PlayVideo.getInstance().playLiveProgram(view, (ChannelInfo)CacheData.getAllChannelMap().get(channelNO));
//	}
//	
